...
// A denormalised snapshot of a Customer, embedded on documents that
// reference one (alongside a customerId) so reads don't need a live lookup
// and history stays accurate even if the customer's own record changes
// later (e.g. their name gets corrected on a later sale).
//
