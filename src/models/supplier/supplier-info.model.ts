...
// A denormalised snapshot of a Supplier, embedded on documents that
// reference one (alongside a supplierId) so reads don't need a live lookup
// and history stays accurate even if the supplier's own record changes
// later.
//
